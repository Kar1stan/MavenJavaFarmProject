...
public class Apple extends Fruit implements Product, Harvestable, Storable, Pricable {
    ...
    public Apple(double weight, boolean ripe, LocalDate harvestDate, int daysToSpoil, boolean organic,
    ...
    @Override
    public void printDaysToSpoil() throws SpoiledException {
        ...
        if (daysRemaining > 0) {
          ...
          // throw new SpoiledException(getName() + " has already spoiled.", new
          // Exception());
          // }
    }
    ...
    public String getStorageAdvice() throws EmptyException {
        String baseAdvice = organic ? "Store in a breathable crate at 1–4°C (organic protection recommended)."
