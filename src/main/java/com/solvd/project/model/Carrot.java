...
public class Carrot extends Vegetable implements Product, Harvestable, Storable, Pricable {
    ...
    public Carrot(double weight, boolean ripe, LocalDate harvestDate, int daysToSpoil, boolean organic,
    ...
    public void harvest() {
        if (ripe) {
            System.out.println("Harvesting carrot 🥕... pull from the soil gently.");
        } else {
            System.out.println("Harvesting unripe carrot 🥕... requires gentle handling and cold storage.");
        }
    }
    ...
    public void cutting() {
        logger.info("Cutting the carrot");
    }
