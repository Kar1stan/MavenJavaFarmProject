...
public class Strawberry extends Berry implements Product, Harvestable, Storable, Pricable {
    ...
    private static final Logger logger = LogManager.getLogger(Strawberry.class);

    public Strawberry(double weight, boolean ripe, LocalDate harvestDate, int daysToSpoil, boolean organic,
    ...
    public int getAntioxidantLevel() {
        return 4;
    }

    public void sugarize() {
        logger.info("Sugarize the strawberries");
    }
}
